...
async def startup_event():
    print("🚀 Iniciando Sistema de Gestão Oficina Mecânica...")
...
async def health_check():
    return {"status": "healthy", "message": "Sistema funcionando offline!"}
...
if __name__ == "__main__":
    print("🏠 Sistema de Gestão Oficina Mecânica - Versão Offline")
    print("="*60)
